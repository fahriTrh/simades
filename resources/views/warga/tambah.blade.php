...
<main class="flex-1 overflow-y-auto p-5 lg:p-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-7 animate-fade-up s1">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-forest-700 text-sm font-semibold">Tambah Warga</span>
            </div>
            <h3 class="text-forest-900 font-bold text-xl">Tambah Data Warga</h3>
            <p class="text-gray-400 text-sm mt-0.5">Isi formulir di bawah untuk mendaftarkan warga baru</p>
        </div>
    ...
    {{-- Form Card --}}
    <form method="POST" action="{{ route('warga.store') }}" class="animate-fade-up s2">
        @csrf
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <label class="flex-1 cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="Laki-laki" class="peer hidden">
                                ...
                                <label class="flex-1 cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="Perempuan" class="peer hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <textarea name="alamat" rows="3" placeholder="Jl. Nama Jalan No. X RT XX/RW XX, Desa/Kelurahan, Kecamatan"
                                    class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-forest-300 focus:border-forest-400 bg-gray-50 placeholder-gray-300 text-gray-800 transition-all resize-none"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="nomor_telepon" placeholder="8xx-xxxx-xxxx"
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-gray-50 border border-dashed border-gray-200">
                                ...
                                <span class="text-xs text-gray-400 italic">Otomatis saat simpan</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-gray-50 border border-dashed border-gray-200">
                                ...
                                <span class="text-xs text-gray-400 italic">Otomatis saat diubah</span>
                            </div>
                        </div>
