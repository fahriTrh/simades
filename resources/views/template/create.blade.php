    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-7 animate-fade-up s1">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-forest-700 text-sm font-semibold">Tambah Template</span>
            </div>
            <h3 class="text-forest-900 font-bold text-xl">Tambah Template Surat</h3>
            <p class="text-gray-400 text-sm mt-0.5">Upload file Word (.docx) yang sudah berisi placeholder</p>
        </div>
