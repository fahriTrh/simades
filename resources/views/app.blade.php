...
<body class="main-bg min-h-screen flex overflow-hidden">
    ...
    <aside id="sidebar" class="sidebar w-64 min-h-screen flex-shrink-0 flex flex-col fixed lg:relative z-40 transition-transform duration-300 -translate-x-full lg:translate-x-0">
        ...
        <nav class="flex-1 py-4 overflow-y-auto px-2 space-y-0.5">
            ...
            {{-- Pengaturan Akun --}}
            <div>
                <button onclick="toggleMenu('menuAkun','chevronAkun')" class="sidebar-item w-full flex items-center gap-3 px-3 py-2.5 rounded-lg">
                    <svg class="item-icon w-5 h-5 text-forest-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <span class="item-label text-forest-200 text-sm flex-1 text-left">Pengaturan Akun</span>
                    <svg id="chevronAkun" class="chevron w-4 h-4 text-forest-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                    </svg>
                </button>
                <div id="menuAkun" class="submenu pl-10 pr-2 space-y-0.5 mt-0.5">
                    <a href="" class="flex items-center gap-2 py-2 px-3 text-sm text-forest-300 hover:text-white rounded-lg hover:bg-white/5 transition-colors">
                        <span class="w-1.5 h-1.5 rounded-full bg-earth-400"></span> Ubah Username
                    </a>
                    <a href="" class="flex items-center gap-2 py-2 px-3 text-sm text-forest-300 hover:text-white rounded-lg hover:bg-white/5 transition-colors">
                        <span class="w-1.5 h-1.5 rounded-full bg-earth-400"></span> Ubah Password
                    </a>
                </div>
            </div>
